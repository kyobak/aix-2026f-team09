...
|---|---|---|---|
| 사용자 Who |  |  | 한양대 에리카 학생 |
| 상황 When/Where |  |  | 학생이 수강신청을 하기 전 계획 단계 |
| 페인포인트 What — 무엇이 **얼마나** |  |  | 수강신청 후 과목 선택에 대한 후회 및 학기 생활의 예상 부재 때문에 불편함을 느낌 |
| 성공 기준 Done |  |  | 여러가지 과목의 수업계획서를 입력하면 과목별 수업 연관성과 해당 과목에서 배우게 될 내용 설명, 전반적인 학기 생활의 예상 |
...
| 질문 | 후보 A | 후보 B | 후보 C |
|---|---|---|---|
| 이 안에 **누구의 정보**가 들어가는가|  |  | 해당 과목 교수님 |
|그 사람이 우리 사용자와 같은 사람인가 |  |  | 아니오 |
| 쓰고 싶어도 **못 쓰는 사람**은 누구인가 |  |  | 에리카 학생이 아닌 다른 학교 학생 |
